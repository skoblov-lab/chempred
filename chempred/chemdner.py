...
import re
from typing import overload, List, Tuple, Iterator, Text, Sequence, Optional, NamedTuple
...
from chempred.annotation import Annotation, ClassifiedRegion, Interval
...
AbstractAnnotation = Tuple[int, Annotation, Annotation]
...
#         -> List[Tuple[int, List[ClassifiedRegion], List[ClassifiedRegion]]]:
#     """
...
#         return [ClassifiedRegion(src, int(start), int(end), text, cls)
#                 for _, src, start, end, text, cls in anno]
#
#     def split_sources(annotations: List[ClassifiedRegion]) \
#             -> Tuple[List[ClassifiedRegion], List[ClassifiedRegion]]:
#         """
...
#
#
# def mask_annotated_regions(text: str, annotations: List[ClassifiedRegion]) -> str:
#     """
#     Replace annotated regions with white space
#     >>> annotations = [ClassifiedRegion(TITLE, 5, 10, "t", "a"),
#     ...                ClassifiedRegion(TITLE, 15, 20, "t", "b")]
#     >>> text = "a" * 20
...
#     True
#     >>> mask_annotated_regions(text, [ClassifiedRegion(TITLE, 20, 21, "t", "a")])
...
#
#
# def annotate_text(text: str, annotations: List[ClassifiedRegion], source: str) \
#         -> List[ClassifiedRegion]:
#     """
...
#     text_anno = [ClassifiedRegion(source, start, end, text_[start:end], cls)
...
#         abstract_annotations: List[Tuple[int, List[ClassifiedRegion], List[ClassifiedRegion]]]) \
#         -> Iterator[Tuple[Tuple[int, str, str],
#                           Tuple[int, List[ClassifiedRegion], List[ClassifiedRegion]]]]:
#     # TODO tests
#     """
...
#         -> List[Tuple[int, str, str, List[ClassifiedRegion]]]:
#     # TODO tests
#     """
